...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'old_suisse' => [
            'driver' => 'mysql',
            'host' => env('OLD_SUISSE_DB_HOST', '127.0.0.1'),
            'port' => env('OLD_SUISSE_DB_PORT', '3306'),
            'database' => env('OLD_SUISSE_DB_DATABASE', 'forge'),
            'username' => env('OLD_SUISSE_DB_USERNAME', 'forge'),
            'password' => env('OLD_SUISSE_DB_PASSWORD', ''),
            'unix_socket' => env('OLD_SUISSE_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'pulse' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_PULSE_DATABASE', 'forge'),
            'username' => env('DB_USERNAME', 'forge'),
            'password' => env('DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
    ...
    */
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'prefix' => env('REDIS_PREFIX', Str::slug(env('APP_NAME', 'laravel'), '_') . '_' . env('APP_ENV', 'production') . '_redis_'),
        ],
