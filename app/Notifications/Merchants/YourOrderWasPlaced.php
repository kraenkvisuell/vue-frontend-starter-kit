...
namespace App\Notifications\Merchants;
...
class YourOrderWasPlaced extends Notification
{
    ...
    {
        $subject = GlobalSet::findByHandle('merchants')->in($this->order->merchant->site)->get('order_confirmation_subject');
        $subject = __('shop.thanks_for_your_order');
