...
class TransferProductVideo implements ShouldQueue
{
            ...
            if ($medium) {
                ...
                if ($asset) {
                    ...
                    if ($possibleSkuNumber) {
                        $newFilename = strtoupper($possibleSkuNumber) . '-HVI-01.mp4';
                    }

                    Storage::disk('sku_import_files')->put(config('shop.sku_merchant_video_import_root') . '/' . $newFilename, $asset);
