...
class ImportSkuSftpMerchantVideos implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $path = config('shop.sku_merchant_video_import_root');
        ...
        foreach ($batches as $articleNumber => $batch) {
            ImportSkuSftpMerchantVideoBatch::dispatch($articleNumber, $batch);
        }
    ...
    protected function getArticleNumber($filepath)
    {
        ...
        $root = config('shop.sku_merchant_video_import_root');
